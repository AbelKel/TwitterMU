...
**TwitterMU** is a basic twitter app to read and compose tweets the [Twitter API](https://apps.twitter.com/).
...
1.The stretch feature that is finding hyperlinks and @mentions 
2. How to play embeded videos in tweets 

## Video Walkthrough

Here's a walkthrough of implemented user stories:

https://i.imgur.com/RsmR3r7.gif
...
- Auto layout for different secitions of the app 
- the unlike/unretweet features feature
